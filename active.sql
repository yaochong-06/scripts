...
col sql_id for a13
select /*+use_nl(a,b,c)*/distinct a.sid,a.serial#,a.username,a.terminal,a.machine,a.program,b.spid,c.sql_id,substr(c.sql_text,0,30) as sql_text
...
to_char(a.logon_time,'yyyymmdd hh24:mi') as logon_time,
